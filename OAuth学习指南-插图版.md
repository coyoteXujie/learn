...
![01_四大角色交互流程](images/01_四大角色交互流程.png)
...
![02_授权码模式详细流程](images/02_授权码模式详细流程.png)
...
![03_隐式模式(已废弃)](images/03_隐式模式(已废弃).png)
...
![04_密码模式(不推荐)](images/04_密码模式(不推荐).png)
...
![05_客户端凭证模式](images/05_客户端凭证模式.png)
...
![06_Provider需要实现的模块](images/06_Provider需要实现的模块.png)
...
![07_普通登录vs_OAuth登录对比](images/07_普通登录vs_OAuth登录对比.png)
...
![08_Token类型对比](images/08_Token类型对比.png)
